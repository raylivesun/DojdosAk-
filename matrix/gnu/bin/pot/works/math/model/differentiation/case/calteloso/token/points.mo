/*
For this reason, the derivative annotation should point to a function that takes the same 
arguments as . In our case, that function, PolynomialFirstDerivative would be defined as 
follows:
